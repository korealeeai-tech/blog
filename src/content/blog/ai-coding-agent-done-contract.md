...
이 글은 특정 회사나 프로젝트의 내부 사례가 아니라, 공개 문서와 개인적인 운영 기준을 바탕으로 정리했다. 확인일은 2026년 7월 6일이다. 이번 글은 특정 UI나 설정 화면을 증명하는 글이 아니라 여러 공개 문서의 짧은 문장을 대조해 완료 기준을 세우는 글이라, 문서 캡처 대신 필요한 짧은 원문 발췌와 한국어 해석을 남긴다.
