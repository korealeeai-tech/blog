...
이 글은 공개 가능한 개념으로만 설명한다. 실제 개인 기록, 내부 review queue, 원문 로그, 업무 화면, 계정, 제품 정보는 다루지 않는다. 2026-07-02 기준 OpenAI Codex와 Claude Code 공식 문서를 재확인했고, 기존 공식문서 캡처는 2026-07-01에 생성된 최소 영역 캡처를 사용한다.
